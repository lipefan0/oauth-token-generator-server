import * as accountsService from '../services/accounts-payable.service.js';
...
export async function createAccount(req, res) {
    ...
    try {
        ...
        const result = await accountsService.createAccountPayable(accountData, token);
...
export async function uploadAccounts(req, res) {
    ...
    try {
        const results = await accountsService.processExcelAccountsPayable(req.file.buffer, token);
...
// src/controllers/accounts-payable.controller.js
export async function downloadTemplate(req, res) {
    ...
    try {
        ...
        res.setHeader('Content-Disposition', 'attachment; filename=template_contas_pagar.xlsx');
